...
import com.crosslink.battleprism.core.misc.Shader;
...
public class Framework {
	...
	public static String COMMON_DATAPATH = "/com/crosslink/battleprism/client/engine/shaders/";
    ...
    public static int createAndLinkProgram(ArrayList<Integer> shaders) {
        try {
            int prog = Shader.createAndlinkProgram(shaders);
            return prog;
        } finally {
