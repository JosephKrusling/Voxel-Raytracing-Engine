...
import com.crosslink.battleprism.core.misc.ImageCreator;
import com.crosslink.battleprism.core.misc.ImageFormat;
import com.crosslink.battleprism.core.misc.ImageSet;
import com.crosslink.battleprism.core.misc.Util;
...
public class DdsLoader {
	...
	public static ImageSet loadFromFile(String ddsFilepath) throws IOException {
		...
		ImageSet.Dimensions ddsDimensions = getDimensions(ddsHeader);
		ImageFormat.UncheckedImageFormat ddsFormat = getFormat(ddsHeader, dds10Header);
	...
	private static ImageSet.Dimensions getDimensions(DdsHeader ddsHeader) {
		ImageSet.Dimensions ddsDimensions = new ImageSet.Dimensions();
	...
	private static int calcLineSize(ImageFormat.UncheckedImageFormat ddsFormat, int lineWidth) {
		// This is from the DDS suggestions for line size computations.
		if (ddsFormat.bitDepth == ImageFormat.BitDepth.COMPRESSED) {
			int blockSize = 16;
	...
	private static int calcMipmapSize(ImageFormat.UncheckedImageFormat ddsFormat, ImageSet.Dimensions ddsDimensions, int mipmapLevel) {
		ImageSet.Dimensions mipmapDimensions = Util.calcMipmapLevelDimensions(ddsDimensions, mipmapLevel);
	...
	private static OldDdsFormatConv s_oldFormatConvert[] = {
			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGBA, ImageFormat.ComponentOrder.RGBA,
					ImageFormat.BitDepth.PER_COMP_8, 1), new OldDdsFmtMatch(
					DdsPixelFormatFlags.RGB | DdsPixelFormatFlags.ALPHAPIXELS,
					32, 0xff, 0xff00, 0xff0000, 0xff000000, 0)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGBA, ImageFormat.ComponentOrder.BGRA,
					ImageFormat.BitDepth.PACKED_32_BIT_8888_REV, 1), new OldDdsFmtMatch(
					DdsPixelFormatFlags.RGB | DdsPixelFormatFlags.ALPHAPIXELS,
					32, 0xff0000, 0xff00, 0xff, 0xff000000, 0)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGBX, ImageFormat.ComponentOrder.RGBA,
					ImageFormat.BitDepth.PER_COMP_8, 1), new OldDdsFmtMatch(
					DdsPixelFormatFlags.RGB, 32, 0xff, 0xff00, 0xff0000, 0, 0)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGB, ImageFormat.ComponentOrder.RGBA,
					ImageFormat.BitDepth.PER_COMP_8, 1), new OldDdsFmtMatch(
			...
			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGB, ImageFormat.ComponentOrder.BGRA,
					ImageFormat.BitDepth.PER_COMP_8, 1), new OldDdsFmtMatch(
			...
			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGB, ImageFormat.ComponentOrder.RGBA,
					ImageFormat.BitDepth.PACKED_16_BIT_565, 1), new OldDdsFmtMatch(
					DdsPixelFormatFlags.RGB, 16, 0xf800, 0x7e0, 0x1f, 0, 0)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGBA, ImageFormat.ComponentOrder.BGRA,
					ImageFormat.BitDepth.PACKED_16_BIT_1555_REV, 1),
			...
			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RGBA, ImageFormat.ComponentOrder.BGRA,
					ImageFormat.BitDepth.PACKED_16_BIT_4444_REV, 1), new OldDdsFmtMatch(
					DdsPixelFormatFlags.RGB, 16, 0xf00, 0xf0, 0xf, 0xf000, 0)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.COMPRESSED_BC1, ImageFormat.PixelComponents.COLOR_RGB,
					ImageFormat.ComponentOrder.COMPRESSED, ImageFormat.BitDepth.COMPRESSED, 1),
					new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0, 0, 0,
							0, MagicNumbers.DDSFOURCC_DXT1)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.COMPRESSED_BC2, ImageFormat.PixelComponents.COLOR_RGBA,
					ImageFormat.ComponentOrder.COMPRESSED, ImageFormat.BitDepth.COMPRESSED, 1),
					new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0, 0, 0,
							0, MagicNumbers.DDSFOURCC_DXT3)),

			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.COMPRESSED_BC3, ImageFormat.PixelComponents.COLOR_RGBA,
					ImageFormat.ComponentOrder.COMPRESSED, ImageFormat.BitDepth.COMPRESSED, 1),
					new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0, 0, 0,
			...
			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RG, ImageFormat.ComponentOrder.RGBA,
					ImageFormat.BitDepth.PER_COMP_16, 1), new OldDdsFmtMatch(
			...
			new OldDdsFormatConv(new ImageFormat.UncheckedImageFormat(
					ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
					ImageFormat.PixelComponents.COLOR_RED, ImageFormat.ComponentOrder.RGBA,
					ImageFormat.BitDepth.PER_COMP_16, 1), new OldDdsFmtMatch(
	...
	private static class OldDdsFormatConv {
		...
		OldDdsFormatConv(ImageFormat.UncheckedImageFormat uncheckedImageFormat, OldDdsFmtMatch ddsFmt) {
