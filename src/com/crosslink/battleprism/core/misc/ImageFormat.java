...
public class ImageFormat {
	...
	public enum PixelComponents {
		COLOR_RED,							// Image contains 1 color component, namely r.
		COLOR_RG,							// Image contains 2 color components, r and g.
		COLOR_RGB,							// Image contains 3 color components, r, g, and blue.
		COLOR_RGBX,							// Image contains 3 color components, r, g, and blue. There is a fourth component, which takes up space in the data but should be discarded.
		COLOR_RGBA,							// Image contains 4 color components, r, g, blue, and alpha.
	...
	public static class UncheckedImageFormat {
		public PixelDataType type;					// The type of pixel data.
		public PixelComponents format;				// The components stored by a pixel.
		public ComponentOrder order;				// The order of the components of the pixel.
		public BitDepth bitDepth;					// The bitdepth of each pixel component.
		...
		public UncheckedImageFormat(PixelDataType type, PixelComponents format,
	...
	public ImageFormat(UncheckedImageFormat uncheckedImageFormat) {
